...
public class User extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5858375174291729270L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"cloud.shareApp\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"favourite_number\",\"type\":[\"int\",\"null\"]}]}");
   ...
   */
  public User(java.lang.CharSequence name, java.lang.Integer favourite_number) {
    this.name = name;
   ...
   */
  public static cloud.shareApp.User.Builder newBuilder() {
    return new cloud.shareApp.User.Builder();
  }
   ...
   * @return A new User RecordBuilder
   */
  public static cloud.shareApp.User.Builder newBuilder(cloud.shareApp.User.Builder other) {
    if (other == null) {
      return new cloud.shareApp.User.Builder();
    } else {
      return new cloud.shareApp.User.Builder(other);
    }
  }
   ...
   * @return A new User RecordBuilder
   */
  public static cloud.shareApp.User.Builder newBuilder(cloud.shareApp.User other) {
    if (other == null) {
      return new cloud.shareApp.User.Builder();
    } else {
      return new cloud.shareApp.User.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cloud.shareApp.User.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cloud.shareApp.User other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public cloud.shareApp.User.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cloud.shareApp.User.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public cloud.shareApp.User.Builder setFavouriteNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public cloud.shareApp.User.Builder clearFavouriteNumber() {
